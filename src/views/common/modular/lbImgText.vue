  ...
  .img-ul-box{
    ...
    li{
      ...
      &.type-li{
        &:nth-child(1){
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img1.png');
          }
        }
        &:nth-child(2){
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img2.png');
          }
        }
        &:nth-child(3){
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img3.png');
          }
        }
        &:last-child{
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img4.png');
          }
        }
        &:hover{
          &:nth-child(3){
            div{
              background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img3.gif');
      ...
      &.pos-li{
        &.img1{
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img-1.png');
          }
        }
        &.img2{
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img-2.png');
          }
        }
        &.img3{
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img-3.png');
          }
        }
        &.img4{
          div{
            background-image: url('https://tsfile.labifenqi.com/staticFile/public/officer/imgText/img-4.png');
          }
        }
      }
      &.on{
